         ...
         <section className="contact__help p-relative pt-115 pb-150">
            ...
            <div className="container">
               ...
               <div className="row p-relative">
                  ...
                  <SIngleContactInfo image="headset" title="Customer Support" btn_text="Visit Support Forum"  subTitle="Feel free to visit our Support Forum for helpful assistance and community discussio"/>
                  <SIngleContactInfo image="msg" title="Any Questions" btn_text="Contact Support" subTitle="Feel free to ask if you have any questions or need clarification."/>
